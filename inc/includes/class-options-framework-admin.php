...
class Options_Framework_Admin {
	...
	static function menu_settings() {
		...
		$menu = array(
            ...
            'page_title' => __( 'ponyblog主题设置', 'theme-textdomain' ),
			'menu_title' => __( 'ponyblog主题设置', 'theme-textdomain' ),
			'capability' => 'edit_theme_options',
			'menu_slug' => 'ponyblog-theme',
	    ...
	    <div id="optionsframework-metabox" class="metabox-holder">
		    <div id="optionsframework" class="postbox">
				...
				<div id="optionsframework-submit">
					...
					<input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( '恢复默认配置', 'theme-textdomain' ); ?>" onclick="return confirm( '<?php print esc_js( __( '确定恢复默认吗 恢复后不可撤销', 'theme-textdomain' ) ); ?>' );" />
					<div class="clear"></div>
				</div>
				</form>
			</div> <!-- / #container -->
	...
	function validate_options( $input ) {
		...
		if ( isset( $_POST['reset'] ) ) {
			add_settings_error( 'options-framework', 'restore_defaults', __( '已经恢复到默认', 'theme-textdomain' ), 'updated fade' );
